/**
 * SmartChats Storage — AppDataStore integration for the SmartChats app
 *
 * Provides a singleton AppDataStore instance scoped to app_id='smartchats',
...
const LEGACY_MIGRATED_FLAG = 'appdata::smartchats::__legacy_migrated__';

// ─── Singleton ───────────────────────────────────────────────────────

const CORTEX_APP_ID = 'smartchats';
 ...
 * new `appdata::smartchats::*` format. Gated by a flag so it only runs once.
