...
// Re-export types from the cortex package for existing callers.
export type { SandboxLog, SandboxEvent, SandboxResult, SandboxExecutor } from 'cortex'
export { DEFAULT_SANDBOX_TIMEOUT }

// Import SandboxResult type for use in this file
import type { SandboxResult } from 'cortex'
