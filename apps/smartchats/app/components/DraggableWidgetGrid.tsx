...
export const DraggableWidgetGrid: React.FC<DraggableWidgetGridProps> = React.memo(({
  visibleWidgets,
  renderWidget,
  onLayoutChange,
  initialLayout
  ...
  // Monitor DOM mutations in the grid (debug only)
  useEffect(() => {
    if (!DEBUG) return;
      ...
      {mounted && (
        ...
        >
          {visibleWidgets.map(widget => (
            <div key={widget.id} className="widget-grid-item widget-auto-contain">
