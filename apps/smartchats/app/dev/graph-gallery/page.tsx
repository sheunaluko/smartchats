...
function generateKGData() {
  return {
    nodes: [
      ...
      { id: 'react_app', label: 'react_app', group: 'project' },
    ...
    edges: [
      ...
      { source: 'user', target: 'react_app', kind: 'created' },
      { source: 'react_app', target: 'smartchats', kind: 'contains' },
      ...
      { source: 'typescript', target: 'react_app', kind: 'used_in' },
